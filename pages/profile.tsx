    ...
    return(
        ...
        <div className="text-white h-full flex justify-center items-center">
            <div className="flex-col flex">
                <h2 className="text-center mb-10 text-4xl text-700">Your account</h2>
                <div className="flex items-center justify-center gap-5">
                   <div className="flex flex-col m-auto w-60 h-60 border shadow-md hover:border-green-600">
                        <div className="flex items-center justify-center h-[150px] w-[150px] mr-auto ml-auto mt-10">
                            <img src={randomImg} alt=""  className="w-max h-max object-contain rounded-[50px] overflow-hidden mr-auto ml-auto"/>
                        </div>
